...
const Model9 = () => {
  ...
  return (
    <div className="main">
      <div>
        <h2 className="main_heading">Customize Building2 Model</h2>
        <div className="row">
                ...
                <React.Suspense fallback={null}>
                  <Bounds fit clip margin={2}>
                    <DynamicMaterialModel
                      modelPath="https://ssvconstructions.in/wp-content/uploads/2025/01/glb_files/ichijoushi___-_004.glb" // Your GLTF model path
