...
const Model5 = () => {
  ...
  return (
    <div className="main">
      <div>
        <h2 className="main_heading">Customize Residental House Model</h2>
        <div className="row">
          <div className="col-lg-2 left" >
            <div>
              <div className="select_part text-center pt-3  ">
                <h5>Selected Part</h5>
                <p className="fw-bold" style={{ color: "#a20000",width:"200px",overflow:"hidden" }}>
                  {selectedPart
                    ? selectedPart.name
                ...
                <React.Suspense fallback={null}>
                  <Bounds fit clip margin={2}>
                    <DynamicMaterialModel
                      modelPath="https://ssvconstructions.in/wp-content/uploads/2025/01/glb_files/small_residental_house.glb" // Your GLTF model path
