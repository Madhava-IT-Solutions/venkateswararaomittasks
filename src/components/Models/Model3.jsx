...
const Model3 = () => {
  ...
  return (
    <div className="main">
      <div>
        <h2 className="main_heading">Customize House2 Model</h2>
        <div className="row">
                ...
                <React.Suspense fallback={null}>
                  <Bounds fit clip margin={2}>
                    <DynamicMaterialModel
                      modelPath="https://ssvconstructions.in/wp-content/uploads/2025/01/glb_files/house2.glb" // Your GLTF model path
